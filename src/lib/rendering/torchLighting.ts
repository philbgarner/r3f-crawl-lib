 ...
 */
export const defaultTorchConfig: TorchConfig = {
  bandNear: DEFAULT_BAND_NEAR,
  torchColor: DEFAULT_TORCH_COLOR,
  torchIntensity: DEFAULT_TORCH_INTENSITY,
  torchHex: DEFAULT_TORCH_HEX,
  tintColors: DEFAULT_TINT_COLORS,
};
...
export function makeTorchUniforms(
  ...
  const cfg = { ...defaultTorchConfig, ...config };
  return {
    uBandNear: { value: cfg.bandNear },
    uTint0: { value: cfg.tintColors[0] },
    uTint1: { value: cfg.tintColors[1] },
    uTint2: { value: cfg.tintColors[2] },
    uTint3: { value: cfg.tintColors[3] },
    uTorchColor: { value: cfg.torchColor },
    uTorchIntensity: { value: cfg.torchIntensity },
  };
}
