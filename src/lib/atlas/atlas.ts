// Atlas index builder.
// Provides name→entry lookup tables for every category in the developer's atlas.json.
// The shape of AtlasData is determined entirely by the atlas.json the developer provides —
// this module has no built-in knowledge of specific category names or tile values.
